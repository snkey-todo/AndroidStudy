...
public class PeerConnectionClientTest extends InstrumentationTestCase
  ...
  @Override
  public void onLocalDescription(String userId, SessionDescription sdp) {
  ...
  @Override
  public void onIceCandidate(String userId, final IceCandidate candidate) {
  ...
  @Override
  public void onIceCandidatesRemoved(String userId, final IceCandidate[] candidates) {
  ...
  PeerConnectionClient createPeerConnectionClient(
          ...
          PeerConnectionClient.PeerConnectionParameters peerConnectionParameters, EglBase.Context eglContext) {
...
//    PeerConnectionClient client = PeerConnectionClient.getInstance();
    PeerConnectionClient client =  new PeerConnectionClient("test", false);
...
//    client.createPeerConnection(eglContext, localRenderer, remoteRenderer);
    client.createOffer();
    return client;
  }

  private PeerConnectionClient.PeerConnectionParameters createParametersForAudioCall() {
  ...
  private PeerConnectionClient.PeerConnectionParameters createParametersForVideoCall(
  ...
  private void doLoopbackTest(PeerConnectionClient.PeerConnectionParameters parameters, boolean decodeToTexure)
      throws InterruptedException {
    loopback = true;
  ...
  public void testLoopbackEglContextReleasedAfterCreatingPc() throws InterruptedException {
    ...
    loopback = true;
    PeerConnectionClient.PeerConnectionParameters parameters = createParametersForVideoCall(VIDEO_CODEC_VP8, true);
    MockRenderer localRenderer = new MockRenderer(EXPECTED_VIDEO_FRAMES, LOCAL_RENDERER_NAME);
