...
public class SelectPictureActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentResolver = getContentResolver();
         ...
         mBitmapUtils=Util.getBitmapUtils(this);
        initView();
    }
...
//                loader.displayImage("file://" + item.path, holder.iv, options);
                mBitmapUtils.display(holder.iv, "file://" + item.path);
...
//            loader.displayImage("file://" + item.getFirstImagePath(), holder.id_dir_item_image, options);
            mBitmapUtils.display( holder.id_dir_item_image,"file://" + item.getFirstImagePath());
