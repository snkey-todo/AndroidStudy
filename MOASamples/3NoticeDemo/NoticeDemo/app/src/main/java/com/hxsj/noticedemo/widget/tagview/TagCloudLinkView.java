...
public class TagCloudLinkView extends RelativeLayout {
	...
	private static final int TAG_LAYOUT_TOP_MERGIN = 5;
	private static final int TAG_LAYOUT_LEFT_MERGIN = 5;
	private static final int INNER_VIEW_PADDING = 10;
	private static final int LAYOUT_WIDTH_OFFSET = 5;
	private static final int DEFAULT_TEXT_SIZE = 18;
	// private static final int DEFAULT_TAG_LAYOUT_COLOR =
	// Color.parseColor("#aa66cc");
	private static final int DEFAULT_TAG_TEXT_COLOR = Color.parseColor("#1a1a1a");
	// private static final int DEFAULT_DELETABLE_TEXT_COLOR =
	...
	private void initialize(Context ctx, AttributeSet attrs, int defStyle) {
		...
		// mTagLayoutColor =
		// typeArray.getColor(R.styleable.TagCloudLinkView_tagLayoutColor,
		// DEFAULT_TAG_LAYOUT_COLOR);
		mTagTextColor = typeArray.getColor(R.styleable.TagCloudLinkView_tagTextColor, DEFAULT_TAG_TEXT_COLOR);
		mTagTextSize = typeArray.getDimension(R.styleable.TagCloudLinkView_tagTextSize, DEFAULT_TEXT_SIZE);
		mIsDeletable = typeArray.getBoolean(R.styleable.TagCloudLinkView_isDeletable, false);
		// mDeletableTextColor =
		// typeArray.getColor(R.styleable.TagCloudLinkView_deletableTextColor,
		// DEFAULT_TAG_TEXT_COLOR);
		// mDeletableTextSize =
		// typeArray.getDimension(R.styleable.TagCloudLinkView_deletableTextSize,
...
//			tagView.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTagTextSize);
			...
			float tagWidth = tagView.getPaint().measureText(tag.getText()) + INNER_VIEW_PADDING * 2; 
			// deletable text
			ImageView deletableView = (ImageView) tagLayout.findViewById(R.id.delete_txt);
			if (mIsDeletable) {
				...
				tagWidth += deletableView.getWidth() + INNER_VIEW_PADDING * 2;
			} else {
